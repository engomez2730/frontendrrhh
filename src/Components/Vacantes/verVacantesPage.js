        ...
        <div>
            ...
            <List.Item>
                <Card title={item.title}>
                    ...
                    <Button type='primary' onClick={()=> showModal(item)}>Postularme</Button>
                </Card>
            </List.Item>)}/>
        <Modal title="Solicitar Vacante" open={isModalOpen} onOk={handleOk} onCancel={handleCancel} width={1000}>
              <CrearSolicitante vacante={props?.vacanteSolicitante}/>
        </Modal>
...
const mapStateToProps = (state) =>{
    return {vacantes:state.Vacantes.vacantes,vacanteSolicitante:state.VacanteSolicitante.vacanteSolicitante}
}
