        ...
        dataSource={[
          {
            ...
            description: "Nombre,cedula,telefono,correo, etc...",
          },
          {
            id: 2,
            name: "Infomracion Empresarial",
            description: "Salario, Vacaciones, Regalia, Prestacions",
          },
        ]}
        bordered
        renderItem={(item) => (
          <List.Item
            ...
            actions={[
              <Button
                onClick={(e) => showDrawer(e, item.id)}
                key={`a-${item.id}`}
              >
                Ver Info
              </Button>,
...
export default connect(stateMapToProps, {})(InfoModal);
