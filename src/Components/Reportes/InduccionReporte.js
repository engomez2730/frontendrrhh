...
export const FormReportes = (props) => {
  ...
  const columns = [
    ...
    {
      title: "Fecha de expiración de Inducción",
      dataIndex: "induccionFechaDeExpiracion",
      key: "induccionFechaDeExpiracion",
      align: "center",
      render: (induccionFechaDeExpiracion) => {
        return (
          <div>
            {induccionFechaDeExpiracion ? (
              <Tag>
                {moment(induccionFechaDeExpiracion).format("MMMM Do YYYY")}
              </Tag>
            ) : (
              <Tag>No tiene</Tag>
            )}
  ...
  return (
    <div>
      <Print
        buttonText="Reporte de Inducción"
        componentToPrint={
          <ReportesTemplate
            title="Reporte"
            Table={
