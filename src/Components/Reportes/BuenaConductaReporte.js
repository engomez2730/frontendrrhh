...
export const FormReportes = (props) => {
  ...
  const columns = [
    ...
    {
      title: "Fecha de expiración de papel de buena conducta",
      dataIndex: "buenaConductaFechaExpiracion",
      key: "celular",
      align: "center",
      render: (buenaConductaFechaExpiracion) => {
        return (
          <div>
            {buenaConductaFechaExpiracion ? (
              <Tag>
                {moment(buenaConductaFechaExpiracion).format("MMMM Do YYYY")}
              </Tag>
            ) : (
              <Tag>No tiene</Tag>
            )}
  ...
  return (
    <div>
      <Print
        buttonText="Reporte de Papel de Buena Conducta"
        componentToPrint={
          <ReportesTemplate
            title="Reporte"
            Table={
