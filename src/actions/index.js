import {GET_PUESTOS,NOMINA_SELECIONADA_VER_GET,PUESTO_SELECT,NOMINAS_COMPLETAS,GET_EPP,NOMINA_SELECTED,NOMINAS_COMPLETA_SELECIONADA,ENTREVISTADOS,DESPIDO_SELECIONADO,GET_DESPIDOS,ENTREVISTADOS_SELECIONADO,BUSCAR_CANDIDATO,BUSCAR_SOLICITANTE, SOLICITANTE_SELEC,VACANTE_SOLICITANTE_SELEC,GET_VACANTE_SELECIONADA, LOG_USER_IN,GET_AVISOS,LOG_USER_OUT,AVISO_SELECIOANDO,SET_COOKIES,SET_USER,LOAD_EMPLEADOS,VER_EMPLEADO,PERMISO_SELECIOANDO,EDITAR_USUARIO,GET_PERMISOS,EDITAR_USUARIO_FINAL, VER_DEPARTAMENTO, CAMBIAR_STATE, GET_VACANTES} from "./types"
