...
export const DESPIDO_SELECIONADO_ACTION = (dataKey) => async (distpatch) => {
    const data = await rrhhApi.get(`/despidos/${dataKey.key}`)
    distpatch({
